...
resource "aws_db_instance" "this" {
  ...
  provisioner "local-exec" {
    command = "echo 'updating RDS password'; sleep 30; aws rds modify-db-instance --db-instance-identifier ${var.identifier} --apply-immediately --master-user-password $DB_PASSWORD; unset DB_PASSWORD"
  }
